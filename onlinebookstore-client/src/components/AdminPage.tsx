...
const categoryOptions = [
  "Biography", "Self-Help", "Classic", "Health", "Thrillers",
  "Historical", "Action", "Christian Books", "Business",
];
...
const AdminPage: React.FC = () => {
  ...
  const fetchBooks = async () => {
    const data = await getBooks(1, 1000, "TitleAsc"); // Fetch a large enough batch
    setBooks(data.books);
  };
  ...
  const handleSave = async () => {
    ...
    if (!currentBook.pageCount || currentBook.pageCount <= 0)
      newErrors.pageCount = "Number of pages must be greater than 0.";
  ...
  return (
    <Container className="mt-5">
      ...
      <div className="d-flex justify-content-end">
        <Button variant="success" onClick={handleAdd}>Add New Book</Button>
      </div>
